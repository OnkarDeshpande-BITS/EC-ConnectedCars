...
loop_count = 0
alert_msg = {'situation' : "accident-nearby" ,"image" : "compressedimagebytes", "alertType" : "VehicleGenerated"}
locationdict = {'latitude' : 45.216 , 'longitude' : -122.636  }
alert_msg["location"] = locationdict
while loop_count < cmdData.input_max_pub_ops:
    if cmdData.input_mode == 'both' or cmdData.input_mode == 'publish':
        ...
        messageJson = json.dumps(alert_msg)
