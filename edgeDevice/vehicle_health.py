...
if __name__ == '__main__':
    ...
    # Subscribe
    print("Subscribing to topic '{}'...".format("cloud/device/info"))
    subscribe_future, packet_id = mqtt_connection.subscribe(
        topic="cloud/device/info",
    ...
    if message_string:
        ...
        while (publish_count <= message_count) or (message_count == 0):
            ...
            carinfo["seqNo"] = publish_count
            carinfo["datetime"] = current_dateTime.strftime("%Y-%m-%d %H:%M:%S")
            print("Publishing message to topic '{}': {}".format(message_topic, carinfo))
            message_json = json.dumps(carinfo)
